...
public class DisplayResultsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String reqTitle = request.getParameter("search1");
        String reqAuthor = request.getParameter("search2");
        String reqGenre = request.getParameter("search3");
        String reqPublisher = request.getParameter("search4");
        String reqSeries = request.getParameter("search5");
        ...
        out.println("<head>");
        out.println("<title>Wyniki wyszukiwania</title>");
        out.println("<style>");
        ...
        out.println("<button class=home-button onclick=window.location.href='hello-servlet'>");
        out.println("<img src=\"images/home_3926885.png\" alt=Home>");
        out.println("</button>");
        out.println("</div>");
        ...
        out.println("<form id=\"sortFormDisplay\" method=\"GET\" action=\"display-servlet\">");
        ...
        out.println("<input type=\"hidden\" name=\"search1\" value=\"" + reqTitle + "\">");
        out.println("<input type=\"hidden\" name=\"search2\" value=\"" + reqAuthor + "\">");
        out.println("<input type=\"hidden\" name=\"search3\" value=\"" + reqGenre + "\">");
        out.println("<input type=\"hidden\" name=\"search4\" value=\"" + reqPublisher + "\">");
        out.println("<input type=\"hidden\" name=\"search5\" value=\"" + reqSeries + "\">");
        out.println("<input type=\"hidden\" name=\"minRating\" value=\"" + minRating + "\">");
        out.println("<input type=\"hidden\" name=\"maxRating\" value=\"" + maxRating + "\">");
        out.println("</form>");
        out.println("</div>");
        out.println("</div>");
        out.println("</div>");
        ...
        try {
            ResultSet resultSet = DataBaseInitializer
                    .getSearched(orderBy, reqTitle, reqAuthor, reqGenre, reqPublisher, reqSeries, minRating, maxRating);
            ...
            if (n == 1){
                out.println("<div class=\"no-results\">Brak wyników pasujących do kryteriów wyszukiwania</div>");
            }
